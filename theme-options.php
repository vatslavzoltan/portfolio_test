			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Some text', 'sampletheme' ); ?></th>
					<td>
						...
						<label class="description" for="sample_theme_options[sometext]"><?php _e( 'Sample Color Scheme', 'sampletheme' ); ?></label>
					</td>
				</tr>
				...
				<tr valign="top"><th scope="row"><?php _e( 'Select input', 'sampletheme' ); ?></th>
					<td>
						...
						<label class="description" for="sample_theme_options[selectinput]"><?php _e( 'Color Scheme', 'sampletheme' ); ?></label>
					</td>
				</tr>
